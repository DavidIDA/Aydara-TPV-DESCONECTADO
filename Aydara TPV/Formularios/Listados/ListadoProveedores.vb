...
#Region "ListadoProveedores_Load"
    Private Sub ListadoProveedores_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.txtTituloListado.EditValue = Me.Text
    End Sub
#End Region

#Region "ListadoProveedores_KeyUp"
    Private Sub ListadoProveedores_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyUp
...
#Region "txtCodigoInicio_Validated"
    Private Sub txtCodigoInicio_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCodigoInicio.Validated
        ...
        Me.txtCodigoInicio.EditValue = Format(CType(Me.txtCodigoInicio.EditValue, Integer), "00000")
        ...
        Try
            cmd.CommandText = "SELECT Nombre FROM PROVEEDORES WHERE Codigo=" & Me.txtCodigoInicio.EditValue
...
#Region "txtCodigoFin_Validated"
    Private Sub txtCodigoFin_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCodigoFin.Validated
        ...
        Me.txtCodigoFin.EditValue = Format(CType(Me.txtCodigoFin.EditValue, Integer), "00000")
        ...
        Try
            cmd.CommandText = "SELECT Nombre FROM PROVEEDORES WHERE Codigo=" & Me.txtCodigoFin.EditValue
...
#Region "bttBuscar_Click"
    Private Sub bttBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttBuscar.Click
        ...
        Try
            ...
            Me.DsProveedores.PROVEEDORES.Load(cmd.ExecuteReader)
